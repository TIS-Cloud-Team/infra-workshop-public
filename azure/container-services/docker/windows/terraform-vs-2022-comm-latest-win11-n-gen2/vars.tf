...
locals {
  ...
  ## vs2022 on win11 gen2
  vm_name="win11-vs2022comm-${local.app_name}"  ## computer_name" can be at most 15 characters
  ## Truncate vm_name to ensure it does not exceed 15 characters
  vm_computer_name = substr(local.vm_name, 0, 15)
  vm_osdisk_name = "win11-vs2022comm-OsDisk-${local.app_name}"
  vm_admin_username = "adminuser"
  vm_admin_password = random_password.password.result
  vm_size = "Standard_D2s_v3" ## Standard_DS1_v2 Standard_DS2_v3
  vm_source_image = {
    publisher = "MicrosoftVisualStudio"
    offer     = "visualstudioplustools"
    sku       = "vs-2022-comm-general-win11-m365-gen2"
    version   = "2024.09.12"  ## latest The platform image 'MicrosoftVisualStudio:visualstudio2022:vs-2022-comm-latest-win11-n-gen2:latest' is not available
  }
  ...
  global_tags = {
    ...
    billing_code    = "abc-pc-1" ## billing code public cloud {departmentcode-pc-123}
